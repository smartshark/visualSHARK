...
setup(
    ...
    version=VERSION,
    python_requires='>=3.6',
    install_requires=['pycoshark @ git+https://github.com/smartshark/pycoSHARK.git@2.0.0', 'networkx>=2.0', 'pika'],
    dependency_links=['git+https://github.com/smartshark/pycoSHARK.git@2.0.0#egg=pycoshark-2.0.0'],
