...
from .views import CommitGraphViewSet, StatsHistoryView, CommitLabelFieldViewSet, PredictionEvaluationView, PredictionView, VSJobViewSet, ReleaseView, IssueLinkCandidatesView, AffectedEntitiesView, IssueLabelSet, IssueConflictSet, IssueLinkSet, CommitLabel
...
urlpatterns = [
    ...
    url(r'^labeling/conflict', IssueConflictSet.as_view()),
    url(r'^labeling/issue', IssueLabelSet.as_view()),
    url(r'^labeling/links', IssueLinkSet.as_view()),
    url(r'^labeling/commit', CommitLabel.as_view()),
